...
class FindActiveSuperpromotionsByPidTest extends AbstractDatabaseTest
{
    ...
    public function testActiveSuperpromotionsAreReceivedACoreEntity()
    {
        ...
        $dbPromotions = $this->promotionRepository->findActiveSuperPromotionsByPid($seriesDbAncestryIds, new DateTimeImmutable(), 300, 0);
    ...
    public function testActiveSuperpromotionsAreReceivedWhenBrandContext()
    {
        ...
        $dbPromotions = $this->promotionRepository->findActiveSuperPromotionsByPid($brandDbAncestryIds, new DateTimeImmutable(), 300, 0);
