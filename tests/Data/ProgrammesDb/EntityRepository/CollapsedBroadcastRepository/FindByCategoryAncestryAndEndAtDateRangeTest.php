...
class FindByCategoryAncestryAndEndAtDateRangeTest extends AbstractDatabaseTest
{
    ...
    public function testFindByCategoryAncestryAndEndAtDateRange(): void
    {
        ...
        foreach ($this->findByCategoryAncestryAndEndAtDateRangeData() as $test) {
            ...
            $data = $repo->findByCategoryAncestryAndEndAtDateRange($categoryAncestry, $isWebcastOnly, $from, $to, $limit, $offset);
            ...
            // findByCategoryAncestryAndEndAtDateRange and ancestry hydration queries
    ...
    public function findByCategoryAncestryAndEndAtDateRangeData(): array
    {
        return [
            // category
            [
                ...
                [
                    ...
                    [
                        'startAt' => new DateTime('2017-01-06 09:30'),
                        'endAt' => new DateTime('2017-01-06 10:30'),
