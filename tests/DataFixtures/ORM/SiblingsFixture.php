...
class SiblingsFixture extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $s1e1 = $this->buildEpisode('b00swgkn', 'Episode 1', 1, new PartialDate(2014), $series1);
        $s1e2 = $this->buildEpisode('b00syxx6', 'Episode 2', 2, new PartialDate(2015), $series1);
        $s1e3 = $this->buildEpisode('b00syxx7', 'Episode 3', 3, new PartialDate(2016), $series1);
    ...
    private function buildEpisode($pid, $title, $position, $releaseDate, $parent = null)
    {
