...
class ProgrammesServiceFindSiblingByProgrammeTest extends AbstractProgrammesServiceTest
{
    ...
    public function testFindNextSiblingByProgrammePrefersSearchingByPositionIfPositionAndReleaseDateArePresent()
    {
    ...
    public function testFindNextSiblingByProgrammeFallsBackToReleaseDateIfPositionAndReleaseDateArePresent()
    {
        $programme = $this->getMockEpisode(1, 3, new PartialDate('2016'));
        $dbData = ['pid' => 'b010t19z'];
...
// ---
    ...
    private function getMockEpisode($parentId = null, $position = null, $releaseDate = null)
    {
