...
abstract class AbstractDatabaseTest extends TestCase
{
    ...
    protected function getDbIdFromPersistentIdentifier(
        string $identifier,
        string $entityType,
        string $identifierName = 'pid'
    ): int {
        return $this->getColumnValueFromIdentifier($identifier, $entityType, 'Id', $identifierName);
    }
    ...
    {
        return $this->getColumnValueFromIdentifier($pid, 'CoreEntity', 'Id');
    }
    ...
    protected function getAncestryFromPersistentIdentifier(
        ...
        $ancestryString = $this->getColumnValueFromIdentifier($identifier, $entityType, 'Ancestry', $identifierName);
    ...
    private function getColumnValueFromIdentifier(
        string $identifier,
        string $entityType,
        string $columnName,
        string $identifierName = 'pid'
