...
/**
 * @ORM\Table(indexes={
 *     @ORM\Index(name="appw_backfill_processed_time_idx", columns={"processed_time"}),
 *     @ORM\Index(name="appw_backfill_locked_at_idx", columns={"locked_at"}),
 *     @ORM\Index(name="appw_backfill_locking_idx", columns={"processed_time","locked","cid"}),
 * })
 ...
 */
class AppwBackfill extends BackfillBase
{
}
